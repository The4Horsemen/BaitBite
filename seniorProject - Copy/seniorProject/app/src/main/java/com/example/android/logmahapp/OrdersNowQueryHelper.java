 ...
 */
public final class OrdersNowQueryHelper {

    /** Tag for the log messages */
    private static final String LOG_TAG = OrdersNowQueryHelper.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link OrdersNowQueryHelper} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name OrdersNowQueryHelper (and an object instance of OrdersNowQueryHelper is not needed).
     */
    private OrdersNowQueryHelper() {
    }

    /**
     * Query the Guardian dataset and return a list of {@link OrderNow} objects.
     */
    public static List<OrderNow> fetchNewData(String requestUrl) {
        // Create URL object
        ...
        // Extract relevant fields from the JSON response and create a list of {@link OrderNow}s
        List<OrderNow> aOrderNows = extractInfoFromJson(jsonResponse);

        // Return the list of {@link OrderNow}s
        return aOrderNows;
    }
    ...
    /**
     * Return a list of {@link OrderNow} objects that has been built up from
     * parsing the given JSON response.
     */
    private static List<OrderNow> extractInfoFromJson(String newJSON) {
        ...
        List<OrderNow> ordersNowList = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                // Create a new {@link OrderNow} object with the textView_OrderNowTitle, textView_OrderNowID, webURL,
                // and textView_OrderNowDate from the JSON response.
                OrderNow aOrderNow = new OrderNow(articleTitle, sectionName, authorName, webPublicationDate, webURL);

                // Add the new {@link OrderNow} to the list of ordersNowList.
                ordersNowList.add(aOrderNow);
            }
