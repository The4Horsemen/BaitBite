...
/**
 * An {@link DishAdapter} knows how to create a list item layout for each dish
...
public class DishAdapter extends ArrayAdapter<Dish> {
    ...
    /**
     * Constructs a new {@link DishAdapter}.
     *
     * @param context of the app
     * @param dishes is the list of dishes, which is the data source of the adapter
     */
    ...
    /**
     * Returns a list item view that displays information about the Dish at the given position
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        textView_orderNowTitle.setText(currentDish.getArticleTitle());
        ...
        sectionNameView.setText(currentDish.getSectionName());
        ...
        textView_orderNowBuyerName.setText(currentDish.getAuthorName());
        ...
        String formattedWebPublicationDateDate = formatDate(currentDish.getWebPublicationDate());
        ...
        button_ordersNow_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Make Dish number "+position+" available", Snackbar.LENGTH_LONG)
